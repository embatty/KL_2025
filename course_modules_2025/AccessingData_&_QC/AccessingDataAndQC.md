...
`cd /home/data/cp2`
The data for this exercise has already been downloaded for you using the following commands, presented here for reference.
<details>
...
Note: The program will exit with an error if the downloaded “.gz” files are truncated/not downloaded completely. If you face such an error, please download the file again and rerun `fastqc`.
