...
1. Use the following Prokka command to annotate the cpe004_hybrid.fasta assembly (this will take 20-30 minutes).  First, create a new environment and install prokka:
